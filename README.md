...
| [`VLESS`](https://sing-box.sagernet.org/configuration/outbound/vless/) [`TCP-XTLS-Vision-REALITY`](https://github.com/XTLS/Xray-examples/tree/main/VLESS-TCP-XTLS-Vision-REALITY) | `vless://<UUID>@<host>:<port>?type=tcp&security=reality&encryption=none&flow=xtls-rprx-vision&pbk=<base64-encoded-public-key>&sid=<shortID>&sni=<server-name>&fp=<fingerprint>#myserv` |
| [`VLESS`](https://sing-box.sagernet.org/configuration/outbound/vless/) [`TCP-XTLS-Vision`](https://github.com/XTLS/Xray-examples/tree/main/VLESS-TCP-XTLS-Vision) | `vless://<UUID>@<host>:<port>?type=tcp&security=tls&encryption=none&flow=xtls-rprx-vision&sni=<server-name>&fp=<fingerprint>&alpn=h2%2Chttp%2F1.1#myserv` |
| [`VLESS`](https://sing-box.sagernet.org/configuration/outbound/vless/) [`TCP-TLS`](https://github.com/XTLS/Xray-examples/tree/main/VLESS-TCP-TLS)<br />[`multiplex (optional)`](https://sing-box.sagernet.org/configuration/shared/multiplex/) | `vless://<UUID>@<host>:<port>?type=tcp&security=tls&encryption=none&sni=<server-name>&fp=<fingerprint>&alpn=h2%2Chttp%2F1.1&multiplex=<protocol>#myserv` |
