...
| [`VLESS`](https://sing-box.sagernet.org/configuration/outbound/vless/) [`TCP-XTLS-Vision-REALITY`](https://github.com/XTLS/Xray-examples/tree/main/VLESS-TCP-XTLS-Vision-REALITY) | `vless://<UUID>@<host>:<port>?type=tcp&security=reality&encryption=none&flow=xtls-rprx-vision&pbk=<X25519-public-key>&sid=<shortID>&sni=<cloak-domain>&fp=<fingerprint>&alpn=h2%2Chttp%2F1.1&packetEncoding=xudp#myserv` |
| [`VLESS`](https://sing-box.sagernet.org/configuration/outbound/vless/) [`TCP-XTLS-Vision`](https://github.com/XTLS/Xray-examples/tree/main/VLESS-TCP-XTLS-Vision) | `vless://<UUID>@<host>:<port>?type=tcp&security=tls&encryption=none&flow=xtls-rprx-vision&sni=<cert-domain>&fp=<fingerprint>&alpn=h2%2Chttp%2F1.1&packetEncoding=xudp#myserv` |
