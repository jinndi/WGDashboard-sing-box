...
| [`Hysteria2`](https://sing-box.sagernet.org/configuration/outbound/hysteria2/)                                                                                                                                                                                  | `hy2://<password>@<host>:<port>/?sni=<cert-domain>&alpn=h3&insecure=0`                                                                                                                                                    |
| [`TUIC`](https://sing-box.sagernet.org/configuration/outbound/tuic/)                                                                                                                                                                                            | `tuic://<UUID>:<password>@<host>:<port>/?sni=<cert-domain>&alpn=h3&congestion_control=<type>&udp_relay_mode=<type>`                                                                                                       |
