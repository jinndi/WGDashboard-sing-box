...
| `WGD_LOG_LEVEL`    | `ERROR`            | `INFO`                       | WGDashboard log level. One of: `DEBUG` `INFO` `WARNING` `ERROR`  `CRITICAL`                                                                                                                                                                 |
| `SB_LOG_LEVEL`    | `error`            | `info`                       | sing-box log level. One of: `trace` `debug` `info` `warn` `error` `fatal` `panic`                                                                                                                                                                 |
