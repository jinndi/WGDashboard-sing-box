...
| [`VLESS`](https://sing-box.sagernet.org/configuration/outbound/vless/) [`TCP-XTLS-Vision-REALITY`](https://github.com/XTLS/Xray-examples/tree/main/VLESS-TCP-XTLS-Vision-REALITY)                                                                               | `vless://<UUID>@<host>:<port>/?security=reality(&type=tcp&encryption=none&flow=xtls-rprx-vision)?&pbk=<X25519-public-key>&sid=<shortID>&sni=<mask-domain>(&fp=<fingerprint>&alpn=<http/1.1,h2,h3>&packetEncoding=xudp)?#myserv` |
