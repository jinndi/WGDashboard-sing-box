...
| `WGD_HOST`         | Autodetect IP           | Domain or IPv4/IPv6 for WG clients.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| `WGD_PORT`         | `10086`                 | WEB UI port.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `LOG_LEVEL`        | `fatal`                 | Log Level. One of:`trace` `debug` `info` `warn` `error` `fatal` `panic`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| `DNS_DIRECT`       | `https://dns.google`    | DNS for sing-box direct outbaund. Supported link types: `local`, `tcp://`, `udp://`, `https://`, `tls://`, `quic://`. Example: `udp://8.8.8.`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| `ROUTE_FINAL`      | `proxy`                 | Default route. If none of the routing rules match, the default route will be applied — either `direct` (for direct internet access) or `proxy` (for access through a proxy server). Example: `direct`                                                                                                                                                                                                                                                                                                                                                                                                                                           |
