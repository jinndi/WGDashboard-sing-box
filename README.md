...
| `PROXY_CIDR`       | `10.10.10.0/24`                     | A comma-separated list CIDR address WireGuard configurations for proxy routing.                                                                                       |
...
| `GEOSITE_BYPASS`   | -                                   | Geosite rules for bypassing proxy by domain names. Use file names from the list (without `geosite-` prefix): https://github.com/SagerNet/sing-geosite/tree/rule-set   |
| `GEOIP_BYPASS`     | -                                   | GeoIP rules for bypassing proxy by country IP addresses. Use file names from the list (without `geoip-` prefix): https://github.com/SagerNet/sing-geoip/tree/rule-set |
| `GEO_NO_DOMAINS`   | -                                   | List of domain names that override `GEOSITE_BYPASS` and `GEOIP_BYPASS` rules and are routed through the proxy.                                                        |
