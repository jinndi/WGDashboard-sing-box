...
| `GEOIP_BYPASS`     | -                                   | Same as `GEOSITE_BYPASS`, but for IP-based routing. Specify the file names (without the `geoip-` prefix and **without the extension**) from the rule set in the repository: https://github.com/SagerNet/sing-geoip/tree/rule-set                                                                                                                                                                                                                                                                                        |
