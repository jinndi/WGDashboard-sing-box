...
| [`Shadowsocks-2022`](https://sing-box.sagernet.org/configuration/inbound/shadowsocks/)<br />[`multiplex (optional)`](https://sing-box.sagernet.org/configuration/shared/multiplex/)                                                                             | `ss://<base64-encoded(<method>:<password>(:<user_password>)?>@<host>:<port>(/?type=tcp&multiplex=<protocol>#<any_name>)?` (SIP002)                                  |
...
| [`Hysteria2`](https://sing-box.sagernet.org/configuration/outbound/hysteria2/)                                                                                                                                                                                  | `hysteria2://<password>@<host>:<port>(/?security=tls&sni=<cert-domain>&alpn=h3&insecure=0#<any_name>)?`                                                                                                                                             |
