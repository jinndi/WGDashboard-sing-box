...
| `ALLOW_FORWARD`    | -                                   | By default, all interfaces and peers are isolated from each other. You can specify interface (configuration) names to remove these restrictions.                      |
...
| `PROXY_CIDR`       | `10.10.10.0/24`                     | CIDR address list from WireGuard configurations for proxy routing.                                                                                                    |
