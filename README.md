...
| `ROUTE_CIDR`       | -                       | A comma-separated list of WireGuard interface IPv4 and IPv6 CIDR addresses to which the routing rules (all options below) will be applied. If no addresses are specified, the routing rules will apply to all interfaces.                                                                                                                                                                                                                                                                                                                                                   |
...
| `BYPASS_GEOIP`     | -                       | Same as `BYPASS_GEOSITE`, but for IP-based routing. [Repository](https://github.com/SagerNet/sing-geoip/tree/rule-set). \*without the `geoip-` prefix and **without the extension**.                                                                                                                                                                                                                                                                                                                                                                                        |
| `PASS_SITES`       | -                       | A comma-separated list of domain names or suffixes. Traffic to domains matching these entries will be routed strictly following `ROUTE_FINAL`. Note: an entry can be a suffix (`example.org`), which allows matching subdomains (`sub.example.org`, etc.). A leading dot is not used for suffixes.                                                                                                                                                                                                                                                                          |
